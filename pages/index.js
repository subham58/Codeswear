...
export default function Home() {
  return (
    <>
      <Head>
        <title>WearCodes.com - Wear the code</title>
        <meta name="description" content="WearCodes.com - Wear the code" />
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            ...
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear Whatever you want, why not wear.</p>
          </div>
